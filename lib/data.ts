...
export const experiences = [
  {
    ...
    events: [
      {
        name: "CodeRush 2.0 2025",
        role: "Organizer",
        date: "24–25 May, 2025",
        description: "Responsible for preparing the budget and managing cash flow throughout the event.",
      },
      {
        name: "IUT 11th National ICT Fest",
        role: "DevOps, Seminar and Workshop Teams",
        date: "26–27 Apr, 2024",
        description:
          "Managed rooms, assisted participants, handled night-time food distribution, oversaw crowd control and guest hospitality.",
      },
      {
        name: "CodeRush 1.0",
        role: "Programming Contest Team",
        date: "18–19 Mar, 2023",
        description: "Contributed to lab setup and invigilation during the programming contest.",
      },
    ],
  },
  {
    ...
    events: [
      {
        ...
        date: "20 & 22 Feb, 2024",
        description: "Bought decoration materials from Dhaka and decorated PS Corner for the exhibition.",
      },
      {
        name: "Break the Circle Season XI, 2023",
        role: "Volunteer",
        date: "7–9 Sep, 2023",
        description: "Handled photography, crowd control, and guest hospitality.",
      },
      {
        name: "Pronoia Intra-IUT Photo Exhibition 2023",
        role: "Logistics Team, Decoration Team",
        date: "13–14 Mar, 2023",
        description: "Bought decoration materials from Dhaka and decorated PS Corner with the team.",
      },
    ],
  },
  {
    ...
    events: [
      {
        name: "2nd Intra IUT Arts and Cultural Exhibition",
        role: "Organizing Team",
        date: "17–18 Jun, 2025",
        description: "Assisted in planning, coordinating exhibits, and managing event logistics.",
      },
      {
        name: "OIC Day Art Exhibition 2024",
        role: "Decoration Team",
        date: "20 & 22 Feb, 2024",
        description: "Assisted in planning, decorating, and curating exhibits.",
      },
    ],
  },
